      ...
      >
        <template>
          <el-form
            ...
            label-width="100px"
          >
            <el-form-item label="充值卡号码" prop="phone_num">
              <el-input v-model="scopeData.phone_num" style="width: 300px" />
            </el-form-item>
            <el-form-item label="充值卡金额" prop="amount">
              <el-input v-model="scopeData.amount" style="width: 300px" />
            </el-form-item>
            <el-form-item label="购买金额" prop="purchasingPrice">
              <el-input
                v-model="scopeData.purchasingPrice"
                style="width: 300px"
              />
            </el-form-item>
            <el-form-item label="使用情况" prop="useStatus">
              <el-input v-model="scopeData.useStatus" style="width: 300px" />
            </el-form-item>
            ...
            <el-form-item label="充值日期" prop="rechargedate">
              <el-date-picker
                v-model="scopeData.rechargedate"
                type="date"
                style="width: 300px"
                placeholder="选择充值日期"
              />
