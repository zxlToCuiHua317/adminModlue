    ...
    <div class="head-container">
        ...
        <template>
          ...
          >
            <el-form-item label="手机号" prop="phone_num">
              <el-input v-model="scopeData.phone_num" style="width: 50%;" />
            </el-form-item>
            <el-form-item label="余额" prop="balance">
              <el-input v-model="scopeData.balance" style="width: 50%;" />
            </el-form-item>
            <el-form-item label="归属地" prop="location">
              <el-input v-model="scopeData.location" style="width: 50%;" />
            </el-form-item>
            <el-form-item label="买卡日期" prop="buydate">
              <el-date-picker
      ...
      >
        ...
        <el-table-column
          ...
          width="100px"
        />
        <el-table-column align="center" prop="phonenum" label="卡号" width="100px" />
        <el-table-column align="center" prop="homeLocation" label="归属地" width="100px" />
        <el-table-column
          align="center"
          prop="money"
          label="金额"
