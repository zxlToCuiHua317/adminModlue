  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      >
        ...
        <el-table-column align="center" prop="language" label="真实名" />
        <el-table-column align="center" prop="os" label="性别" />
        <el-table-column align="center" prop="deviceInformation" label="生日" />
        <el-table-column align="center" prop="deviceVersion" label="电话" />
      </el-table>
      <!--分页组件-->
      <pagination />
    </div>
